...
import kang20.ytcreator.payment.PaymentConsumePort;
...
import kang20.ytcreator.payment.internal.service.support.ProductCatalogProperties;
import kang20.ytcreator.payment.internal.service.support.SubscriptionApplyWriter;
import kang20.ytcreator.payment.internal.service.support.SubscriptionGate;
import kang20.ytcreator.payment.internal.service.support.WebhookAuthenticator;
...
public class PaymentService
		implements PaymentReaderPort, PaymentPurchasePort, PaymentConsumePort, PaymentWebhookPort {
	// 클라에서 만료시간을 보내기 때문에 한국시간으로 변경하는 Offset 이 필요함
